    ...
    out PSInput PSIn)
{
    ...
    float3x3 norm_mat = (float3x3)(g_Model * g_View);

    PSIn.vertexNormal = mul(VSIn.Norm,norm_mat);
    ...
    PSIn.Norm = mul(VSIn.Norm, (float3x3)g_Model);
