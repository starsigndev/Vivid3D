...
void main(){
    ...
    if(diff<g_CelShadeValue){
        diff = g_CelShadeValue/2;
    }else{

        diff = (1.0-g_CelShadeValue);
   ...
   if(spec<g_CelShadeValue){
        spec = g_CelShadeValue/2;
    }else{
        spec = (1.0-g_CelShadeValue);
    }
