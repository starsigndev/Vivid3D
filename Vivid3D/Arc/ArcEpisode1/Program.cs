...
namespace ArcEpisode1
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Welcome to Arc - Episode One \"The Search For home\"");
            ...
            native_settings.NumberOfSamples = 2;
            //VividApp.InitialState = new StateMainMenu();

            VividApp.InitialState = new States.StateLogos();
            ArcApp game = new ArcApp(game_win, native_settings);
            game.Run();
