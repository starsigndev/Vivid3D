...
namespace Vivid.Physics
{
    ...
    public static class QPhysics
    {
        ...
        public static void InitPhysics()
        {
           ...
           _Sim = Simulation.Create(bufferPool, new NarrowPhaseCallbacks(), new PoseIntegratorCallbacks(new Vector3(0, -10, 0)), new SolveDescription(8, 1));
           threadDis = new ThreadDispatcher(Environment.ProcessorCount);
        }
        static ThreadDispatcher threadDis;
