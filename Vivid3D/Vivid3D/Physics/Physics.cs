...
namespace Vivid.Physics
{
    ...
    public static class QPhysics
    {
		...
		public static PhysX.Physics _Physics = null;
        ...
        public static void InitPhysics()
        {
			...
			_Physics = new PhysX.Physics(_Foundation,true, _Pvd);
        ...
        public static bool Raycast(Vector3 origin, Vector3 dest, Physx.PXBody ignore)
        {
